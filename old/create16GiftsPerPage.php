...
foreach ( $codes as  $code ){
	...
	$red = imagecolorallocate( $image, 210, 77, 56 );

	// Put the texts
	imagettftext( $image, 25, 0, 331, 170, $darkGrey, $fontAmbleBold, 'Redeem at' );
	imagettftext( $image, 20, 0, 331, 225, $red, $fontAmbleBold, '' . $code );

	imagettftext( $image, 110, 0, 80, 205, $middleGrey, $fontAmbleBold, '$5' );

	imagettftext( $image, 17, 0, 115, 285, $lightGrey, $fontChunkfive, 'Gift card' );
